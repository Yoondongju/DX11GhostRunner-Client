...
class CParticle_Electric final : public CPartObject
{
public:
...
private:
	CParticle_Electric(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CParticle_Electric(const CParticle_Electric& Prototype);
	virtual ~CParticle_Electric() = default;
...
public:
	static CParticle_Electric* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);

...
_bool CCollider::IsBoundingCollisionEnter()
{
	return m_pBounding->IsBoundingCollisionEnter();
}

_bool CCollider::IsBoundingCollisionStay()
{
	return m_pBounding->IsBoundingCollisionStay();
}

_bool CCollider::IsBoundingCollisionExit()
{
	return m_pBounding->IsBoundingCollisionExit();
}

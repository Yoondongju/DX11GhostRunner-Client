...
HRESULT CFont_Manager::Render(const _wstring& strFontTag, const _tchar* pText, _fvector vPosition, _float fScale, _fvector vColor, _float fRadian, _fvector vPivot)
{
	...
	return pFont->Render(pText, vPosition, fScale , vColor, fRadian, vPivot);
}

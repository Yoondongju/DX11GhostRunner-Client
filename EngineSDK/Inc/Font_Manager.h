...
public:
	...
	HRESULT Render(const _wstring& strFontTag, const _tchar* pText, _fvector vPosition,  _float fScale = 1.f , _fvector vColor = XMVectorSet(1.f, 1.f, 1.f, 1.f), _float fRadian = 0.f, _fvector vPivot = XMVectorSet(0.f, 0.f, 0.f, 1.f));

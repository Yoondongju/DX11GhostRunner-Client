...
public:
	...
	HRESULT Add_CloneObject_ToLayer(_uint iLevelIndex, const _wstring& strLayerTag, const _wstring& strPrototypeTag, const _wstring& strModelPrototypeTag ,void* pArg);
...
public:
	...
	class CLayer*	   Delete_Layer(_uint iLevelIndex, const _wstring& strLayerTag);
